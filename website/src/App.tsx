...
function AppContent() {
  ...
  useEffect(() => {
    ...
    const shouldShowPages =
      isHomePage || isStatsPage || isRoadmapPage || isDownloadsPage || isCareersPage || isPolicyPage;
  ...
  }, [isHomePage, isStatsPage, isRoadmapPage, isDownloadsPage, isCareersPage, isPolicyPage, isInitialLoad]);

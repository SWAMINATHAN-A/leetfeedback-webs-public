...
const DynamicIslandContainer = ({ children }: { children: ReactNode }) => {
  return (
    <div 
      className="z-50 flex h-full w-full items-center justify-center bg-transparent relative"
...
const DynamicIslandContent = ({
  ...
  return (
    <motion.div
      id={id}
      className="mx-auto h-0 w-0 items-center justify-center border border-black/10 bg-[#0A0A0A] text-center text-black transition duration-300 ease-in-out focus-within:bg-neutral-900 hover:shadow-md dark:border dark:border-white/5 dark:focus-within:bg-[#0A0A0A]"
      animate={{
